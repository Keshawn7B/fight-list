...
const curatedFightEvents: FightEvent[] = [
  ...
  {
    id: "raf12-dvalishvili-cejudo",
    sport: "Wrestling",
    promotion: "RAF",
    eventName: "RAF12: Dvalishvili vs Cejudo 2",
    fighters: ["Merab Dvalishvili", "Henry Cejudo"],
    stakes: "Lightweight championship main event",
    ...
    watch: {
      provider: "FOX Nation",
      access: "Subscription",
      href: "https://nation.foxnews.com/real-american-freestyle-nation/",
      note: "Streams live exclusively on FOX Nation",
    },
    detailsUrl: "https://www.realamericanfreestyle.com/events/raf12",
    bouts: [
      "Merab Dvalishvili vs Henry Cejudo",
      "Jordan Burroughs vs Sean Brady",
      "Bo Nickal vs Max McEnelly",
      "Tyron Woodley vs Joaquin Buckley",
      "Evan Wick vs Jason Nolf",
      "Vladimer Khinchegashvili vs Jesse Mendez",
      "David Carr vs Tajmuraz Salkazanov",
      "Kennedy Blades vs Diana Avsaragova",
